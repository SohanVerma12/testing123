...
export default function Home2Page() {
  ...
  const features = [
    { icon: ReceiptText, title: 'Smart Billing', description: 'Fast, accurate, and GST-compliant invoicing.' },
    { icon: Boxes, title: 'Inventory Control', description: 'Real-time stock alerts and recipe management.' },
    { icon: AreaChart, title: 'Actionable Reports', description: 'Insightful analytics to drive growth.' },
    { icon: Bot, title: 'Process Automation', description: 'Reduce manual work and operational errors.' },
    { icon: TabletSmartphone, title: 'Multi-Device Access', description: 'Manage your business from anywhere, on any device.' }
  ];
    ...
    <div className="flex flex-col min-h-screen bg-background antialiased">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 max-w-2xl mx-auto lg:mx-0 text-lg sm:text-xl text-muted-foreground">
              Another Head provides intuitive tools for cafes, restaurants, pharmacies, and payroll management to help you run your business smoother, faster, and better.
            </p>
      ...
      <Container id="industries" className="bg-secondary/40">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">One Platform, Many Solutions</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {industries.map(industry => (
            <Card key={industry.title} className="text-center hover:shadow-xl transition-shadow duration-300">
      ...
      <Container id="features">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">Powerful Features, Simply Delivered</h2>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
            Everything you need to streamline operations and grow your business, all in one place.
          </p>
        </div>
      ...
      <Container id="testimonials" className="bg-secondary/40">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">Trusted by Businesses Like Yours</h2>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {testimonials.map(item => (
            <Card key={item.name} className="p-6 bg-card">
              <CardContent className="p-0">
                <blockquote className="text-lg italic text-foreground/80 mb-4">"{item.quote}"</blockquote>
                <div className="flex items-center gap-4">
                  <Image src="https://placehold.co/100x100.png" width={48} height={48} alt={item.name} className="rounded-full" data-ai-hint={item.avatarHint} />
                  <div>
      ...
      <Container id="demo">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">See How It Works</h2>
          <p className="mt-4 text-lg text-muted-foreground mb-8">
            Words can only say so much. Watch our product demo to see the Another Head platform in action.
          </p>
